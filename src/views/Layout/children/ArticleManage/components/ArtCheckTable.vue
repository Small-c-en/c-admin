...
<template>
  <div>
    <el-table :data="tableData" style="width: 100%; margin-top: 40px; font-size: 16px">
      ...
      <el-table-column prop="edit" label="文章审核">
        <template #default="obj">
          ...
          <el-button type="success" @click="handSucsCheck(obj)" plain>通过审核</el-button>
          <el-button type="danger" @click="handFailCheck(obj)" plain>未通过</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 显示弹窗 展示文章信息 -->
